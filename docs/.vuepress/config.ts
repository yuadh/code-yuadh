...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'yuadh/code-yuadh', // 导航栏右侧生成Github链接
    ...
    footer: {
      ...
      copyrightInfo:
        'yuadh | <a href="https://github.com/yuadh/code-yuadh/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
